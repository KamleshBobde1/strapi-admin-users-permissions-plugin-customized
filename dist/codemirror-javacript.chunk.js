"use strict";
(self["webpackChunkfresh_users_permissions"] = self["webpackChunkfresh_users_permissions"] || []).push([["codemirror-javacript"],{
  ...
  CodeMirror.defineMode("javascript", function (config, parserConfig) {
    ...
    return {
      startState: function startState(basecolumn) {
        ...
        if (parserConfig.globalVars && (0, _typeof2["default"])(parserConfig.globalVars) == "object") state.globalVars = parserConfig.globalVars;
        return state;
      },
