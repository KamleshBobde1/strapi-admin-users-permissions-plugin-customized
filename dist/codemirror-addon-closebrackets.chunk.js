"use strict";
(self["webpackChunkfresh_users_permissions"] = self["webpackChunkfresh_users_permissions"] || []).push([["codemirror-addon-closebrackets"],{
...
(function (mod) {
  ...
  function getOption(conf, name) {
    ...
    if ((0, _typeof2["default"])(conf) == "object" && conf[name] != null) return conf[name];
